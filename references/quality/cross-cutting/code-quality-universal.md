> **Rule mapping:** `ENG-*` (size/complexity/nesting/params) + `ENG-006` (DRY — evidence-gated). Covers reuse audit, parameter sprawl, leaky abstractions, TOCTOU, stringly-typed code.
